...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin{
  ...
  void initState() {
    ...
    _cragarHistorial( this.chatService.usuarioPara!.uid);
  }

  void _cragarHistorial(String uid)async{
               ...
               :Container(
                 ...
                 child: IconTheme(
                   ...
                   child: IconButton(
                     ...
                     splashColor: Colors.transparent,//Para que no se vea el circulo
  ...
  _handleSubmit(String texto){
    ...
    final newMesage= new ChatMessage(
      uid: authServices.usuario!.uid,//Los mensajes que escriba tienen mi identificador 
      texto: texto,
